...
const NAV_GROUPS: NavGroup[] = [
  {
    items: [
      ...
      { to: "/followups", label: "Follow-ups", icon: "M4 4h16v12H5.17L4 17.17V4zm4 4h8M8 11h5" },
        ...
        return (
          <div key={gi} className="flex flex-col gap-1">
            ...
            {items.map((item) => {
              ...
              return <NavLink key={item.to} item={item} active={active} onNavigate={onNavigate} />;
            })}
          </div>
        );
      })}
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        {menuOpen ? (
          <div className="fixed inset-0 z-[120] md:hidden">
            ...
            />
            <div
              className="absolute inset-y-0 left-0 flex w-[82%] max-w-xs flex-col border-r border-line bg-gradient-to-b from-surface to-[#0b100d] shadow-2xl shadow-black/50"
