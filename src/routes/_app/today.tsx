    ...
    <Card className="overflow-hidden border-signal/25">
      ...
      <div className="flex flex-wrap items-center gap-3 border-b border-line bg-signal-soft/20 px-4 py-3">
        ...
        <div className="h-2 min-w-[120px] flex-1 overflow-hidden rounded-full bg-surface-2 shadow-[inset_0_1px_3px_rgba(0,0,0,0.12)]">
          <div
            className="h-full rounded-full bg-gradient-to-r from-signal-strong via-signal to-[#dcb85e] shadow-[0_0_12px_rgba(168,132,44,0.7)] transition-[width] duration-500"
      ...
      {current ? (
        <>
          ...
          <div className="px-4 py-5 sm:px-6" style={{ perspective: "1200px" }}>
            <div
              className={cx(
                "relative mx-auto max-w-xl rounded-2xl border border-line-strong bg-gradient-to-br from-[#fffdf8] to-surface p-6 shadow-[0_30px_70px_-30px_rgba(0,0,0,0.2),0_0_50px_-30px_rgba(168,132,44,0.6)] transition-all duration-300",
          ...
          <div className="flex justify-center gap-3 px-4 pb-5">
            ...
            <button
              ...
              disabled={busy}
              className="flex w-36 flex-col items-center gap-1 rounded-xl bg-gradient-to-b from-[#c9a648] to-signal-strong py-3 text-sm font-bold text-white shadow-[0_8px_30px_rgba(168,132,44,0.45)] transition-all hover:-translate-y-0.5 hover:shadow-[0_12px_40px_rgba(168,132,44,0.6)] disabled:opacity-50"
            >
