  ...
  return (
    <div className="flex flex-col items-center">
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at center, rgba(255,77,28,0.08), rgba(11,10,8,0.9) 72%)",
          boxShadow: "inset 0 0 40px rgba(255,77,28,0.08)",
        }}
      >
        ...
        <div
          ...
          style={{
            width: `${ringPct}%`,
            height: `${ringPct}%`,
            borderColor: "rgba(255,77,28,0.55)",
            boxShadow: on ? "0 0 12px rgba(255,77,28,0.25)" : "none",
          }}
        />
        ...
        {on && !paused ? (
          <div
            ...
            style={{
              background:
                "conic-gradient(from 0deg, rgba(255,77,28,0) 0deg, rgba(255,77,28,0) 288deg, rgba(255,77,28,0.05) 320deg, rgba(255,77,28,0.35) 356deg, rgba(255,77,28,0.7) 360deg)",
          ...
          return (
            ...
            >
              ...
              <div
                ...
                style={{
                  boxShadow: "0 0 6px rgba(255,77,28,0.9)",
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
          <div
            ...
            style={{ boxShadow: "0 0 8px rgba(255,77,28,0.9)" }}
          />
        </div>
